  ...
  return (
    ...
    <div className='hidden md:flex flex-wrap justify-end' style={{marginTop:-40}}>
       <button onClick={login}>Sign-In</button>
        ...
        <FiMenu  className="md:hidden flex flex-wrap justify-end" style={{marginLeft:320, marginTop:-50, backgroundColor:'green', width:35, height:30, padding:4, borderRadius:6, cursor:'pointer'}} onClick={toggleMenu} size={24} />
